...
class Checkbox(Element):
    ...
    def __init__(self, 
            ...
            on_update: Optional[Callable[['Checkbox'], None]] = None
        ):
    ...
    def render(self):
        ...
        return (f'<Checkbox bridge-id="{self.id}" id="{self.name}" {selected_arg} {event_arg} {style_arg} {size_arg} {color_arg}>{self.label}</Checkbox>')